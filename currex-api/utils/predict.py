...
def preprocess_image(image_bytes:bytes)->np.ndarray:
    """
    Takes raw images bytes resizes it applies preprocessing and returns the array
    """
...
def decode(predictions:np.ndarray,top_k:int=3):
    """
    Takes model output probabilities, returns top predicted clas and confidence
    """
